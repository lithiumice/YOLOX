...
python tools/demo.py video -n yolox-tiny -c ./yolox_tiny.pth --path /path/to/your/video --conf 0.25 --nms 0.45 --tsize 640 --save_result --device gpu
python tools/demo.py webcam -n yolox-tiny -c ./yolox_tiny.pth --camid 0 --conf 0.25 --nms 0.45 --tsize 640 --device gpu --save_result --fp16
python tools/demo.py webcam -n yolox-tiny -c ./yolox_tiny.pth --camid 0 --conf 0.25 --nms 0.45 --tsize 640 --device gpu --save_result
python tools/demo.py webcam -n yolox-nano -c /home/lithiumice/YOLOX/YOLOX_outputs/yolox_voc_nano_tail/epoch_120_ckpt.pth --camid 0 --conf 0.25 --nms 0.45 --tsize 416 --device gpu --save_result
python tools/trt.py -n yolox-tiny -c ./yolox_tiny.pth
